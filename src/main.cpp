...
uint256 hashGenesisBlock("0x4227d8bbe96b4340f5bb3b83e00822e3f2481a57714cc1a52ef3c555394aaac2");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // MarsCoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 302400; // MarsCoin: 3.5 days
static const int64 nTargetSpacing = 150; // MarsCoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // MarsCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // MarsCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf3cf13d3b2559990e2dedc42620990e56f28846c19f4cea79aadbbc822102a4e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Congratulation! A new world is opening with Marscoin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0d9a90728214a822b5f4372ff06942c7d64ffb3d8778d995df03f9ba15c9f258bec8e55f1c8bfd14016c2dded5d16c8287a140413e8092ceaf989b11a64d792aa6") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1504869096;
        block.nBits    = 504365644;
        block.nNonce   = 712544864;

        if (fTestNet)
        {
            block.nTime    = 1504869096;
            block.nNonce   = 3705884720;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x06d063464b74297a01f7035bd4112c896beed783fa66c9ec37ef3be3e3bd9339"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // MarsCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MarsCoinMiner : ProcessBlock, block not accepted");
    }
